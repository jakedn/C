    ...
    do
    {
        ...
        else
        {
            while (fgets(line, MAX_SIZE + 1, f) != NULL)
            {
                ...
                {
                    printLine(file_path, line, oneFile);
                }
            }
            if (fclose(f) == EOF)
            {
